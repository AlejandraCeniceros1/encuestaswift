...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var btnAlumno: UIButton!
    @IBOutlet weak var btnProfesor: UIButton!
    @IBOutlet weak var btnEmpleado: UIButton!
    ...
    override func viewDidLoad() {
        ...
        gradiente2.frame = btnAlumno.bounds;

        gradiente2.colors = [UIColor(red: 0, green: 30/255, blue: 98/255, alpha: 1).cgColor, UIColor(red: 200/255, green: 16/255, blue: 46/255, alpha: 1).cgColor]

        gradiente2.shouldRasterize = true
        
        btnAlumno.layer.addSublayer(gradiente2)
        
        btnEmpleado.layer.cornerRadius = 25
